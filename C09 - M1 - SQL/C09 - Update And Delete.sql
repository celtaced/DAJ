...
insert into Contactos (PrimerNombre, SegundoNombre, PrimerApellido, SegundoApellido, ApellidoCasada, FechaNacimiento, LugarTrabajo)
VALUES ('Juan', 'Carlos', 'Perez', 'Melgar', '-', '1992/09/03', '-') ;
...
UPDATE Contactos
SET apellidocasada = 'ID MAYOR A TRES'
where idcontacto > 3

update contactos
set apellidocasada = 'Varios criterios'
where primernombre = 'Juan' and primerapellido = 'Martínez';

update contactos
set apellidocasada = 'Misma referencia'
where apellidocasada = '-';

-- Actualizar mas de un campo

update contactos
set apellidocasada = null, lugartrabajo = 'Empresa';
...
delete from contactos where idcontacto = 6


select * from tipodirecciones

insert into tipodirecciones(descripcion) values('Casa');

insert into tipodirecciones(descripcion) values('Oficina'), ('Familiar uno'), ('Direccion Factura');


select * from numerostelefono

insert into numerostelefono(codarea, telefono,idtipotelefono) values('503','35555555','1'), ('503','45555555','1'),('503','65555555','1');